...
class Stack:
    ...
    def __init__(self, capacity):   # remember to get user input for the capacity of the stack
        ...
        # increase by 1 when pushing and decrease by 1 when poping
    ...
    def push(self, value):
        ...
        if self.stack_is_full():   # if stack is full
            print("Sorry you can't add any items to the stack, you've reached maximum capacity.")

        else:  # if the stack isn't full, continue the process to push the item
            ...
            return "{} has been appended to your stack".format(value)

    # REMOVES ITEM FROM TOP OF STACK
    def pop(self):
        # check if stack is empty
        if self.stack_is_empty(): # if stack is empty
            print("Sorry, You can remove an item as your stack is already empty.")
