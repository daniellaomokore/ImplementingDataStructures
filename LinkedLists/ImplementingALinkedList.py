...
class Node:
    ...
    def __init__(self, data,next_node=None):  # nextNode is initialised as default to none when a new node is created,
...
class LinkedList:
    ...
    def insert_at_index(self, data, index):
        ...
        if self.head == None or index == 0:  # if the list is empty or you want to insert at the first element of the list
            ...
            new_node.next_node = previous_node.next_node  # set the new nodes next node to point to node that is
    ...
    def delete_at_tail(self):
        ...
        while current_node.next_node.next_node is not None:  # while the current node is not, node before the tail node
    ...
    def delete_at_index(self, index):
        ...
        if index == 0:  # if you want to delete the first node of the ll
            ...
            previous_node.next_node = previous_node.next_node.next_node  # Make the previous node to our element
